# Multi-TV Builder Power for Kiro

Use this Kiro power to build production-ready cross-platform TV applications with React Native - supporting Android TV, Apple TV, Fire TV (Fire OS & Vega OS), and Web TV platforms with a single codebase.

## What is This Power?

It combines monorepo architecture, shared UI components, platform-specific optimizations, and TV-optimized navigation into a unified development framework.

This power is designed for use with [Kiro](https://kiro.dev), more on [Kiro Powers](https://kiro.dev/docs/powers/)
...
Once installed, the power activates automatically when you mention TV development in your conversation with Kiro. You can also explicitly reference it:
